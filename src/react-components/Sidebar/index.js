        ...
        return (
            <div className='side-bar'>
                <div className='side-bar-search'>
                    <p className='side-bar-title'> 所有的<span className='p-en'>Biases</span>(偏倚)</p>
                    ...
                    <Autocomplete
                        ...
                        renderInput={(params) => 
                            <TextField {...params} 
                                InputLabelProps={{style: {fontSize: 12, fontWeight:300, fontFamily: "Microsolft Yahei"}}}
                                label="选择您要查询的偏倚"/>
                        }
                    />
                </div>
                ...
                <div className='side-bar-bias-list'>
                    <p className='side-bar-title'>检索最多的<span className='p-en'>Bias</span>(偏倚)</p>
