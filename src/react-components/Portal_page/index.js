            ...
            <div className='introduction'>
                ...
                <div className='grid-container'>
                    ...
                    <div className='grid-content'>
                        ...
                        <p className='portal-text double-space' id='wider'><span className='bold-text p-en' >Onion</span> 从多个维度提出突破“先验研究”的建议，使研究者的研究成为“迈出前沿的一小步、推进前沿的一大步”</p>
                    </div>
                </div>
                <div className='grid-container'>
                    <div className='grid-content'>
                        <p className='portal-subtitle'>文献积累，<span className='p-en'>Onion</span> 辅助研究者</p>
                        <p className='portal-text'>检索的文献如果不能进行有效的分析则很难为研究提供帮助。文献积累应该怎样做？<span className='bold-text p-en' >Onion</span> 向导研究者有导向性的积累文献，并作出分析图表；</p>
                        <p className='portal-text'>先验研究的重要信息呈现在“检索文献归纳”中。</p>
                        <p className='portal-text'>一目了然！</p>
                    </div>
                    <div className='grid-img'>
                ...
                <div className='grid-container'>
                    ...
                    <div className='grid-content'>
                        ...
                        <p className='portal-text'>界面交互，运用“最容易理解”的问题与研究者交互信息，当不易理解时，研究者可根据 <span className='bold-text p-en'>Onion</span> 的提示，轻松完成交互……</p>
                    </div>
                ...
                <div className='grid-container'>
                    <div className='grid-content'>
                        ...
                        <p className='portal-text'>如何进行假设、研究设计、是否“巢氏”设计、“如何随机”、“样本量估计方法”、“统计学分析方法”、“变量处理”、“偏倚控制策略”、“敏感性分析”、“亚组分析”……</p>
                    </div>
                    <div className='grid-img'>
                ...
                <div className='grid-container'>
                    ...
                    <div className='grid-content'>
                        ...
                        <p className='portal-text'>规范的研究方案“向导”，针对每个撰写模块 <span className='bold-text p-en' >Onion</span>  都发出提示，研究者只需跟随 <span className='bold-text p-en' >Onion</span>  的向导即可高效的完成一份研究方案 & 报告；</p>
