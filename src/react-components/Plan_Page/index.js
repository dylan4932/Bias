            ...
            <div className='introduction'>
                ...
                <div className='plan-grid'>
                    <div className='grid-container'>
                        ...
                        <div className='portal-content' id='move-up'> 
                            ...
                            <p className='portal-text tab-space' id='wider'> 在于“临床研究者”大量的沟通、交流中发现：在研究的实践中有不少问题使研究者们感到困惑，而针对这些具体问题作专题讨论的场合并不多见。研究者们在这些“<span className='bolder p-en'>Difficult point</span>” 问题上，[ 尤其是“真实世界研究”（<span className='bolder p-en'>Real World Study</span>）领域的一些问题 ]需要帮助。</p>
                            <p className='portal-text tab-space' id='wider'> 鉴于此，<span className='bolder p-en'>BJHPA | Research Design Group</span> 的专家们，将这些“<span className='bolder p-en'>Difficult point</span>”问题汇总、整理、形成多个专题。</p>
                            <p className='portal-text tab-space' id='wider'> 您可以选择下面列表中的1~2个专题，组织一次 “<span className='p-en bolder'>Onion 专题研讨会</span>”。</p>
                            <p className='portal-text tab-space' id='wider'> <span className='bolder p-en'>BJHPA | Research Design Group</span> 的专家们可以和研究者们就这些被选择的专题进行深入的研讨、交流，进而助力您的研究方案。</p>
                            <br/>
                ...
                <div className='grid-container'>
                        ...
                        <div className='portal-content'> 
                            ...
                            <p className='portal-text'> 比如，我们在与临床研究者的交流中就发现“真实世界研究的 ‘一些关键变量’ 的处理、‘ 偏倚的识别与控制’……”，都是研究者常常面临的 “<span className='bolder p-en'>Difficult point</span> ”。</p>
                            <p className='portal-text'> <span className='bold-text p-en'>Onion</span> 的 <span className='bold-text p-en'>AI</span> 决策功能可以帮助研究者，研究者的创想和情景可以在 <span className='bold-text p-en'>Onion</span> 中进行“<span className='bolder p-en'>研究方案模拟</span>”。可以帮助研究者在过程中了解相关研究知识、模拟研究方案写作，最终，模拟过程使研究者获得一份高质量的<span className='bolder p-en'>研究方案（Research protocol）</span>。</p>
                            <p className='portal-text'> 您可以将“<span className='bold-text p-en'>Onion</span> 研究方案模拟”选入 “<span className='bold-text p-en'>Onion</span> 专题研讨会”中作为会议的一个模块，并由<span className='bolder p-en'> BJHPA | Research Design Group</span> 的专家们引导您完成此过程。</p>
                            <p className='portal-text'> 我们称其为“<span className='bolder p-en'>Onion 研究方案模拟</span>”！</p>
                            <br/>
                        </div>
                        <div className='grid-img'>
