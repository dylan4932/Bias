...
import education_col1 from '../../onion_icons/education-col1.png'
import education_col2 from '../../onion_icons/education-col2.png'
import education_col3 from '../../onion_icons/education-col3.png'
import education_col4 from '../../onion_icons/education-col4.png'
            ...
            <div className='introduction'>
                ...
                <div className='education-subtitle'>
                    <div className='subtitle-col'>
                        <img id='check' src={education_col1} alt='education-colomn-icon1'></img>
                        <p className='portal-text'>如何引导研究者或学生确定研究的类型？</p>
                    </div>
                    <div className='subtitle-col'>
                        <img id='check' src={education_col2} alt='education-colomn-icon2'></img>
                        <p className='portal-text'>如何让研究者或学生以规范的“模式”撰写研究方案？将合适的内容写在合适的位置。</p>
                    </div>
                    <div className='subtitle-col'>
                        <img id='check' src={education_col3} alt='education-colomn-icon3'></img>
                        <p className='portal-text'>如何帮助研究者或学生建立一个好的“研究方案”？包括“研究方案” & “统计分析计划”？</p>
                    </div>
                    <div className='subtitle-col light-text'>
                        <img id='check' src={education_col4} alt='education-colomn-icon4'></img>
                ...
                <div className='education-block1'>
                    <p className='education-text'><span className='p-en'>With Onion</span>，医学生有了“<span className='p-en'>personal trainer</span>” </p>
