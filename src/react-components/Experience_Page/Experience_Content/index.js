...
import experience_plan_img1 from '../../../content-img/experience-img1.png'
        ...
        return (
            <div className='cataly-content'>
                ...
                <div className='cataly-plan-grid'>
                    <div className='grid-container'>
                        <div className='portal-content' id='move-up'> 
                            ...
                            <p className='portal-text' id='wider'> 辅助做好临床研究，是 <span className='p-en bold-text'>KOLs</span> 和专家们显而易见的兴趣和需求</p>
                            <p className='portal-text' id='wider'> <span className='p-en bold-text'>Onion</span> 体验覆盖专家的效率很高，质量有保证。</p>
                ...
                <div className='cataly-plan-section-title' id='move-down'>
                    ...
                    <p className='cataly-plan-section-text bold-text'> <span className='p-en'>Onion Experience Meeting</span> 专题研讨</p>
                </div>
                ...
                <div className='grid-container'>
                    ...
                    <div className='portal-content'> 
                        <p className='portal-subtitle'><span className='p-en bold-text'>Onion Experience Part 1</span>  :做个观众</p>
                        <br />
                        <p className='portal-text'> <span className='p-en bold-text'>Art</span>  医生是一位 “辅助生殖”领域的医生，想进行高质量的临床研究，但是 <span className='p-en bold-text'>Art</span> 医生并没有很清晰的主题，对临床研究的设计也不是特别熟悉。不过 <span className='p-en bold-text'>Art</span> 医生结合 <span className='p-en bold-text'>Onion RsearchAI<sup id='copy-right'> ®</sup></span> 系统轻松的完成了研究。</p>
                ...
                <div className='grid-container'>
                    <div className='portal-content' id='move-down'> 
                        <p className='portal-subtitle'><span className='p-en bold-text'>Onion Experience Part 2</span>  :做个研究者</p>
                        <br />
                ...
                <div className='grid-container'>
                    ...
                    <div className='portal-content'> 
                        <p className='portal-subtitle'><span className='p-en bold-text'>Onion Experience Part 3</span>  :做个同行评议者</p>
                        <br />
                        ...
                        <p className='portal-text'> 在研究的实践中有不少问题使研究者们感到困惑，而针对这些具体问题作专题讨论的场合并不多见。鉴于此，<span classNme='p-en bold-text'>Onion RsearchAI<sup id='copy-right'> ®</sup></span> 的专家们，将这些“<span className='p-en'>Difficult point</span>”整理、形成多个专题。结合<span className='p-en'>Onion Experience</span> 的过程，选择下面列表中的1~2个专题展开，从“同行评议”的角度进行研究设计 & 统计分析的探讨。</p>
                ...
                <div className='cataly-plan-schedule'>
                    <div className='cataly-plan-schedule-img-title'>
                        ...
                        <p className='portal-medium-text'>“ <span className='p-en bold-text'>Onion Experience Meeting</span> ”</p>
                    </div>
                            ...
                            <div className='cataly-plan-schedule-col-content'>
                                <div className='cataly-plan-schedule-col-content-left'>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <p className='portal-text' id='wider'> <span className='p-en bold-text'>Onion RsearchAI<sup className='copy-right'> ®</sup></span> 引导可行的研究方向；</p>
                                        </li>
                                        <li>
                                ...
                                <div className='cataly-plan-schedule-col-content-right'>
                                    <div>
                                        ...
                                        <br/>
                                        <p className='portal-text green-text bolder cataly-center-text'><span className='p-en bold-text'>Onion</span> 研究体验—形成研究的关键框架</p>
                                        <ul>
                                            <li>
