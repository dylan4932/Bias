            ...
            <div className='cataly-content'>
                ...
                <div className='cataly-plan-grid'>
                    <div className='grid-container'>
                        ...
                        <div className='portal-content' id='move-up'> 
                            ...
                            <br/>
                            <p className='portal-text'> “关注医院管理者的需求，需要改变 <span className='p-en bold-text'>Key Account Management</span> 的知识结构、能力模型、以及互动方式！”</p>
                ...
                <div className='cataly-plan-grid'>
                    <div className='grid-container'>
                        ...
                        <div className='portal-content' id='move-up'> 
                            ...
                            <p className='portal-text tab-space' id='wider'> 鉴于此，<span className='p-en bold-text'>Onion RsearchAI</span><sup className='copy-right'>®</sup> <span className='p-en bold-text'>| Cataly</span> 的专家们，将这些“ <span className='p-en bold-text'>Key point</span> ”整理、形成几个专题。</p>
                            <p className='portal-text tab-space' id='wider'> 您可以选择下面列表中的1~2个专题，组织一次 “<span className='p-en bold-text'>Onion Cataly</span> 专题研讨”</p>
                            <p className='portal-text tab-space' id='wider'> <span className='p-en bold-text'>Onion RsearchAI</span><sup className='copy-right'>®</sup> <span className='p-en bold-text'>| Cataly</span> 的专家们可以和研究者们就这些专题进行深入的研讨、交流，进而助力研究者。</p>
                            <br/>
                ...
                <div className='grid-container'>
                    ...
                    <div className='portal-content'> 
                        ...
                        <p className='portal-text'> <span className='p-en bold-text'>Onion RsearchAI</span><sup className='copy-right'>®</sup> <span className='p-en bold-text'>| Cataly</span> 可以帮助研究者的 <span className='p-en bold-text'>Idea</span> 在 <span className='p-en bold-text'>AI</span> 系统 中进行“研究方案设计的浸入式体验”。可以帮助研究者在体验/交互过程中了解相关研究知识、模拟研究方案写作，最终，模拟过程使研究者获得一份高质量的“研究方案”（ <span className='p-en bold-text'>Research protocol</span> ）。</p>
                        <p className='portal-text'> 您可以将“<span className='p-en bold-text'>Onion</span> 研究体验”选入 “<span className='p-en bold-text'>Onion</span> 专题研讨会”中作为会议的一个模块， <span className='p-en bold-text'>Onion RsearchAI</span><sup className='copy-right'>®</sup> <span className='p-en bold-text'>| Cataly</span> 的专家们与您共同完成此过程。</p>
                    ...
                    <div className='grid-img'>
                        ...
                        <p className='portal-text double-space' id='wider'>适合的听众 : 有意将自己的医管想法、实践以及经验，通过研究形成“循证证据”的医疗管理者或研究者。</p>
                        <p className='portal-text double-space' id='wider'>有意将自己的“研究 <span className='p-en bold-text'>Idea</span>” 与 <span className='p-en bold-text'>Onion RsearchAI</span><sup className='copy-right'>®</sup> <span className='p-en bold-text'>| Cataly</span> 进行信息交互，模拟撰写、最终获得一份研究方案的研究者。</p>
                        ...
                        <div className='cataly-plan-schedule-col'>
                            ...
                            <div className='cataly-plan-schedule-col-content'>
                                <div className='cataly-plan-schedule-col-content-left'>
                                    ...
                                    <ul>
                                        <li>
                                            <p className='portal-text'> 医疗管理者将自己的研究 <span className='p-en bold-text'>Idea</span> 与 <span className='p-en bold-text'>Onion RsearchAI</span><sup className='copy-right'>®</sup> <span className='p-en bold-text'>| Cataly</span> 信息交互；</p>
                                        </li>
                                        <li>
                                            <p className='portal-text'> <span className='p-en bold-text'>Onion RsearchAI</span><sup className='copy-right'>®</sup> <span className='p-en bold-text'>| Cataly</span> 引导可行的研究方向；</p>
                                        </li>
                                        <li>
                                            <p className='portal-text'> <span className='p-en bold-text'>Onion RsearchAI</span><sup className='copy-right'>®</sup> <span className='p-en bold-text'>| Cataly</span> 激发研究灵感</p>
                                        </li>
                                    </ul>
                                </div>
                                <div className='cataly-plan-schedule-col-content-right'>
                                    <div>
                                        ...
                                        <ul>
                                            <li>
                                                <p className='portal-text'> 医疗管理者将自己的研究 Idea 与 <span className='p-en bold-text'>Onion RsearchAI</span><sup className='copy-right'>®</sup> <span className='p-en bold-text'>| Cataly</span> 进行信息交互；</p>
                                            </li>
                                            <li>
                                                <p className='portal-text'> <span className='p-en bold-text'>KOL</span> & 员工共同探索 </p>
                                            </li>
                                            <li>
                                                <p className='portal-text'> <span className='p-en bold-text'>Onion RsearchAI</span><sup className='copy-right'>®</sup> <span className='p-en bold-text'>| Cataly</span> 进行研究情境分析。 </p>
                                            </li>
                                        </ul>
                                        <br/>
                                        <p className='portal-text green-text bolder cataly-center-text'>Onion Cataly 体验—明确研究情境</p>
                                        <ul>
                                            <li>
                                                <p className='portal-text'> <span className='p-en bold-text'>Onion RsearchAI</span><sup className='copy-right'>®</sup> <span className='p-en bold-text'>| Cataly</span> 的 <span className='p-en bold-text'>AI</span> 算法，提供关键问题的决策</p>
                                            </li>
                                            <li>
