            ...
            <div className='intro-container'>
                <div className='intro-content'>
                    <div className='intro-left'>
                        ...
                        <p className='portal-text'>经过 <span className='bold-text p-en'>AI</span> 决策，<span className='bold-text p-en'>Onion</span> 将在研究的类型、设计、技术路径、样本量估计方法、统计学方法、偏倚控制策略、等方面为研究者提供 <span className='bold-text p-en'>AI</span> 辅助。</p>
