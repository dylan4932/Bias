            ...
            <div className='introduction'>
                ...
                <div className='demo-container'>
                    ...
                    <div className='demo-content'>
                        ...
                        <br/>
                        <p className='demo-subtitle double-space'>Onion 激发灵感</p>
                        <p className='demo-text double-space'>Onion 从多个维度提出突破“先验研究”的建议，使研究者的研究成为“迈出前沿的一小步、推进前沿的一大步”</p>
                    </div>
                ...
                <div className='demo-container'>
                    ...
                    <div className='demo-content'>
                        <p className='demo-subtitle'>AI 辅助，形成研究的关键框架（Framework）：</p>
                        <p className='demo-text'>Onion 的AI算法，根据用户交互的信息，一键式生成了研究“Framework”（关键框架），在这个“Framework”里面包括了研究非常关键的、也是经常困扰临床研究者的问题之解决方案，包括：</p>
